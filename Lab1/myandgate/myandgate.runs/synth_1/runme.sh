...
HD_PWD='/home/A01577421/Desktop/ECE2700/Lab1/myandgate/myandgate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myandgate.vds -m64 -mode batch -messageDb vivado.pb -notrace -source myandgate.tcl
