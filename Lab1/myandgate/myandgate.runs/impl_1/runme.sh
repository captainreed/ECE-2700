...
HD_PWD='/home/A01577421/Desktop/ECE2700/Lab1/myandgate/myandgate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myandgate.vdi -applog -m64 -messageDb vivado.pb -mode batch -source myandgate.tcl -notrace
