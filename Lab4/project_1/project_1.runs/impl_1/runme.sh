...
HD_PWD='/home/A01577421/Desktop/ECE2700/Lab4/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dlatch.vdi -applog -m64 -messageDb vivado.pb -mode batch -source dlatch.tcl -notrace
