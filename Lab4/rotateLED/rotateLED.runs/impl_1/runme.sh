...
HD_PWD='/home/A01577421/Desktop/ECE2700/Lab4/rotateLED/rotateLED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rotateLed.vdi -applog -m64 -messageDb vivado.pb -mode batch -source rotateLed.tcl -notrace
