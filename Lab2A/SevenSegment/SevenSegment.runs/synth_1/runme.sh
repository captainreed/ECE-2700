...
HD_PWD='/home/A01577421/Desktop/ECE2700/Lab2A/SevenSegment/SevenSegment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSegmentTop.vds -m64 -mode batch -messageDb vivado.pb -notrace -source SevenSegmentTop.tcl
