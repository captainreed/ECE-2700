...
HD_PWD='/home/A01577421/Desktop/ECE2700/Lab2A/SevenSegment/SevenSegment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSegmentTop.vdi -applog -m64 -messageDb vivado.pb -mode batch -source SevenSegmentTop.tcl -notrace
