...
HD_PWD='/home/A01577421/Desktop/ECE2700/Lab3/DoubleSevenSegment/DoubleSevenSegment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DoubleSevenSegment.vdi -applog -m64 -messageDb vivado.pb -mode batch -source DoubleSevenSegment.tcl -notrace
